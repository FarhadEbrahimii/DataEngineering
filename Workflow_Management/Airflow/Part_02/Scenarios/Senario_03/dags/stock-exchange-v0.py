...
read_stock_exchange_xlsx_file = BashOperator(
    ...
    # bash_command='curl --retry 10 --output /tmp/daily_trades_$(echo $RANDOM).xls -L -H "User-Agent:Chrome/61.0" --compressed "http://members.tsetmc.com/tsev2/excel/MarketWatchPlus.aspx?d=0"',
